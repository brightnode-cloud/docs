...
Once created, you can use your account to deploy Nodes, create Serverless endpoints, and access other Brightnode services. Personal accounts can be converted to team accounts at any time to enable collaboration features.
...
| Create/delete/start/stop Nodes | ❌ | ❌ | ✅ | ✅ |
...
This role allows users to access the team account and connect to already-deployed computing resources (e.g., Nodes and Serverless endpoints) for development work. Users with this role cannot view billing information, start or stop Nodes, or create new resources.
...
This role includes all basic permissions plus the ability to start, stop, and create Nodes. Developers can fully manage computing resources for their work while remaining restricted from billing information and account settings.
...
* [Deploy your first Node](/get-started) to start using GPU resources.
