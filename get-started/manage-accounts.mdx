...
Once created, you can use your account to deploy Pods, create Serverless endpoints, and access other Brightnode services. Personal accounts can be converted to team accounts at any time to enable collaboration features.
