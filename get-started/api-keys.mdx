...
description: "Learn how to create, edit, and disable Brightnode API keys."
---
...
1. In the Brightnode console, navigate to the [Settings page](https://www.console.brightnode.cloud/user/settings).

2. Expand the **API Keys** section and select **Create API Key**.

3. Give your key a name and set its permissions (**All**, **Restricted**, or **Read Only**). If you choose **Restricted**, you can customize access for each Brightnode API:
...
Brightnode does not store your API key, so you may wish to save it elsewhere (e.g., in your password manager, or in a GitHub secret). Treat your API key like a password and don't share it with anyone.
...
1. Navigate to the [Settings page](https://www.console.brightnode.cloud/user/settings).
