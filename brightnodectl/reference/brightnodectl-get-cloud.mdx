...
List only GPUs from the [Secure Cloud](https://docs.brightnode.cloud/nodes/choose-a-node#secure-cloud-vs-community-cloud).
</ResponseField>

<ResponseField name="-c, --community">
List only GPUs from the [Community Cloud](https://docs.brightnode.cloud/nodes/choose-a-node#secure-cloud-vs-community-cloud).
</ResponseField>
