...
List only GPUs from the [Secure Cloud](https://docs.brightnode.cloud/pods/choose-a-pod#secure-cloud-vs-community-cloud).
</ResponseField>

<ResponseField name="-c, --community">
List only GPUs from the [Community Cloud](https://docs.brightnode.cloud/pods/choose-a-pod#secure-cloud-vs-community-cloud).
</ResponseField>
