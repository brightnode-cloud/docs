...
<RequestExample>
```sh Command
brightnodectl create pods [flags]
```
</RequestExample>
...
The Docker container image to use for the Pods (e.g., `Brightnode/pytorch:latest`).
</ResponseField>
...
- [`brightnodectl create pod`](/brightnodectl/reference/brightnodectl-create-pod)
