...
OhMyBrightnode is a Python package that solves one of the most common Brightnode user challenges: **easily transferring files to and from your Pod**.
...
- An active Brightnode account with a running Pod.
...
<Steps>
  <Step title="Ensure Port 22 is Exposed">
    ...
    To expose port 22:
    1. Go to your Pod in the Brightnode console
    2. Click **Edit Pod**
