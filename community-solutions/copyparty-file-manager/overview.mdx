...
CopyParty provides a webbased GUI that makes file management simple on Brightnode instances. With its intuitive interface, you can browse directories, upload/download files, preview images and videos, and manage your Node's filesystem without complex command-line operations.
...
- **Terminal access to your Node** - Either through web terminal or Jupyter Labs terminal.
- An available HTTP port on your Node.
...
If you see this option when clicking "Connect" on your Node page, you have web terminal access:
![Web Terminal Access](webterminal.png)

#### Option 2: JupyterLab terminal
If you have JupyterLab installed on your Node, you can access the terminal there:
![JupyterLab Terminal](labsterminal.png)

## Installation steps

### Step 1: Access your Node settings

Navigate to your Node page and locate the settings:
![Edit Node Settings](edit.png)

### Step 2: Add an HTTP port

<Warning>
**Adding a new port will restart your Node and erase any data not stored in `/workspace`**
...
1. **Data Persistence**: Always store important files in `/workspace` to survive node restarts
...
- [Cloud storage integration](/nodes/storage/cloud-sync) (S3, Google Drive, etc.)
