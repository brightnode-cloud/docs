...
To use TMUX, you need terminal access to your Brightnode Pod (SSH, web terminal, or JupyterLab terminal).
...
TMUX is not installed by default on Brightnode Pods. To install it, run:
...
When using TMUX on Brightnode Pods, keep these tips in mind:
