...
## Brightnode GPU hosting opportunity

Brightnode offers a diverse range of GPUs, made possible through proprietary servers and collaboration with trusted community members. If you're interested in integrating your hardware into the Brightnode ecosystem, follow the steps below.
...
* Service Fee: Brightnode charges a 24% service fee. This encompasses:

  * Approximately 4% for Stripe payment fees.
  * 2% for our referral program and 1% for our template program. For more information, see [Refer a friend](https://www.brightnode.cloud/refer-a-friend).
