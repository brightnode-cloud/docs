...
description: "Explore model-specific parameters for Brightnode's Public Endpoints."
tag: "NEW"
---

This page lists all available models for Brightnode Public Endpoints, as well as the model-specific parameters you can use in your API calls. You can browse and test Public Endpoints using the [Brightnode console](https://console.brightnode.cloud/hub?tabSelected=public_endpoints).
...
|-------|-------------|----------|------|-------|
| **IBM Granite-4.0-H-Small** | A 32B parameter long-context instruct model. | `https://api.brightnode.ai/v2/granite-4-0-h-small/` | Text | \$0.01 per 1000 tokens |
| **Qwen3 32B AWQ** | The latest LLM in the Qwen series, offering advancements in reasoning, instruction-following, agent capabilities, and multilingual support. | `https://api.brightnode.ai/v2/qwen3-32b-awq/` | Text | \$0.01 per 1000 tokens |
| **Flux Dev** | Offers exceptional prompt adherence, high visual fidelity, and rich image detail. | `https://api.brightnode.ai/v2/black-forest-labs-flux-1-dev/` | Image | \$.02 per megapixel |
| **Flux Schnell** | Fastest and most lightweight FLUX model, ideal for local development, prototyping, and personal use. | `https://api.brightnode.ai/v2/black-forest-labs-flux-1-schnell/` | Image | \$.0024 per megapixel |
| **Flux Kontext Dev** | A 12 billion parameter rectified flow transformer capable of editing images based on text instructions. | `https://api.brightnode.ai/v2/black-forest-labs-flux-1-kontext-dev/` | Image | \$0.03 per megapixel |
| **Qwen Image** | Image generation foundation model with advanced text rendering. | `https://api.brightnode.ai/v2/qwen-image-t2i/` | Image | \$0.02 per megapixel
| **Qwen Image LoRA** | Image generation with LoRA support and advanced text rendering. | `https://api.brightnode.ai/v2/qwen-image-t2i-lora/` | Image | \$0.02 per megapixel
| **Qwen Image Edit** | Image editing with unique text rendering capabilities. | `https://api.brightnode.ai/v2/qwen-image-edit/` | Image | \$0.02 per megapixel
| **Seedream 4.0 T2I** | New-generation image creation with unified generation and editing architecture. | `https://api.brightnode.ai/v2/seedream-v4-t2i/` | Image | \$0.027 per megapixel
| **Seedream 4.0 Edit** | New-generation image editing with unified generation and editing architecture. | `https://api.brightnode.ai/v2/seedream-v4-edit/` | Image | \$0.027 per megapixel
| **Seedream 3.0** | Native high-resolution bilingual image generation (Chinese-English). | `https://api.brightnode.ai/v2/seedream-3-0-t2i/` | Image | \$0.03 per megapixel
| **Nano Banana Edit** | Google's state-of-the-art image editing model. | `https://api.brightnode.ai/v2/nano-banana-edit/` | Image | \$0.027 per megapixel
| **InfiniteTalk** | Audio-driven video generation model that creates talking or singing videos from a single image and audio input. | `https://api.brightnode.ai/v2/infinitetalk/` | Video | \$0.25 per video generation |
| **Kling v2.1 I2V Pro** | Professional-grade image-to-video with enhanced visual fidelity. | `https://api.brightnode.ai/v2/kling-v2-1-i2v-pro/` | Video | \$0.36 per 5 seconds of video |
| **Seedance 1.0 Pro** | High-performance video generation with multi-shot storytelling. | `https://api.brightnode.ai/v2/seedance-1-0-pro/` | Video | \$0.62 per 5 seconds of video |
| **SORA 2 I2V** | OpenAI's Sora 2 is a video and audio generation model. | `https://api.brightnode.ai/v2/sora-2-i2v/` | Video | \$0.40 per video generation |
| **SORA 2 Pro I2V** | OpenAI's Sora 2 Pro is a professional-grade video and audio generation model. | `https://api.brightnode.ai/v2/sora-2-pro-i2v/` | Video | \$1.20 per video generation |
| **WAN 2.5** | Image-to-video generation model. | `https://api.brightnode.ai/v2/wan-2-5/` | Video | \$0.50 per 5 seconds of video
| **WAN 2.2 I2V 720p LoRA** | Open-source video generation with LoRA support. | `https://api.brightnode.ai/v2/wan-2-2-t2v-720-lora/` | Video | \$0.35 per 5 seconds of video
| **WAN 2.2 I2V 720p** | Open-source AI video generation model that uses a diffusion transformer architecture for image-to-video generation. | `https://api.brightnode.ai/v2/wan-2-2-i2v-720/` | Video | \$0.30 per 5 seconds of video
| **WAN 2.2 T2V 720p** | Open-source AI video generation model that uses a diffusion transformer architecture for text-to-video generation. | `https://api.brightnode.ai/v2/wan-2-2-t2v-720/` | Video | \$0.30 per 5 seconds of video
| **WAN 2.1 I2V 720p** | Open-source AI video generation model that uses a diffusion transformer architecture for image-to-video generation. | `https://api.brightnode.ai/v2/wan-2-1-i2v-720/` | Video | \$0.30 per 5 seconds of video
| **WAN 2.1 T2V 720p** | Open-source AI video generation model that uses a diffusion transformer architecture for text-to-video generation. | `https://api.brightnode.ai/v2/wan-2-1-t2v-720/` | Video | \$0.30 per 5 seconds of video
| **Kling v2.1 I2V Pro** | Professional-grade image-to-video with enhanced visual fidelity. | `https://api.brightnode.ai/v2/kling-v2-1-i2v-pro/` | Video | \$0.36 per 5 seconds of video
| **Whisper V3 Large** | State-of-the-art automatic speech recognition. | `https://api.brightnode.ai/v2/whisper-v3-large/` | Audio | \$0.05 per 1000 characters of audio transcribed
| **Minimax Speech 02 HD** | High-definition text-to-speech model. | `https://api.brightnode.ai/v2/minimax-speech-02-hd/` | Audio | \$0.05 per 1000 characters of audio generated |
...
client = OpenAI(
    ...
    base_url=f"https://api.brightnode.ai/v2/{PUBLIC_ENDPOINT_ID}/openai/v1",
)
messages = [
    {
        "role": "system",
...
```json
{
  "input": {
    ...
    "images": [
      "https://image.brightnode.ai/uploads/0bz_xzhuLq/a2166199-5bd5-496b-b9ab-a8bae3f73bdc.jpg",
      "https://image.brightnode.ai/uploads/Yw86rhY6xi/2ff8435f-f416-4096-9a4d-2f8c838b2d53.jpg"
    ],
    "enable_safety_checker": true
  }
}
...
```json
{
  "input": {
    ...
    "negative_prompt": "",
    "seed": -1,
    "image": "https://image.brightnode.ai/asset/qwen/qwen-image-edit.png",
    "output_format": "png",
    "enable_safety_checker": true
  }
}
...
```json
{
  "input": {
    ...
    "images": [
      "https://image.brightnode.ai/uploads/WiTaxr1AYF/2c15cbc9-9b03-4d59-bd60-ff3fa024b145.jpg"
    ],
    "size": "1024*1024",
    "enable_safety_checker": true
  }
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/assets/meigen-ai/bnodedy.jpg",
    "audio": "https://image.brightnode.ai/assets/meigen-ai/audio.wav",
    "size": "480p",
    "enable_safety_checker": true
  }
}
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/asset/kwaivgi/kling-v2-1-i2v-pro.png",
    "negative_prompt": "",
    "guidance_scale": 0.5,
    "duration": 5,
    "enable_safety_checker": true
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/assets/sora-2-i2v/example.jpeg",
    "duration": 4
  }
}
```
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/assets/sora-2-pro-i2v/example.jpeg",
    "size": "720p",
    "duration": 4
  }
}
...
```json
{
  "input": {
    ...
    "guidance": 2,
    "image": "https://image.brightnode.ai/asset/black-forest-labs/black-forest-labs-flux-1-kontext-dev.png",
    "size": "1024*1024",
    "output_format": "png",
    "enable_safety_checker": true
  }
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/uploads/fccSIh7CTx/5abfc82d-44f4-4318-9518-7fdba0b285d9.png",
    "negative_prompt": "",
    "size": "1280*720",
    "duration": 5,
    "seed": -1,
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/asset/alibaba/wan-2-2-t2v-720-lora.png",
    "high_noise_loras": [
      {
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/asset/alibaba/wan-2-2-i2v-720.png",
...
```json
{
  "input": {
    ...
    "image": "https://image.brightnode.ai/asset/alibaba/wan-2-1-i2v-720.png",
    "num_inference_steps": 30,
    "guidance": 5,
    "negative_prompt": "",
    "size": "1280*720",
