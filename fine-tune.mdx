...
## Deploy the fine-tuning node

Follow these steps to set up your training environment:

1. Click **Deploy the Fine Tuning Node**
...
After your node is deployed and active, you can connect using any of these methods:

1. Go to your Fine Tuning node dashboard
...
To use SSH, add your public SSH key in your account settings. The system automatically adds your key to the node's `authorized_keys` file.
