...
This guide explains how to fine-tune a large language model using Brightnode and Axolotl. You'll learn how to select a base model, configure your training environment, and start the fine-tuning process.

## Prerequisites

Before you begin fine-tuning, ensure you have:

* A Brightnode account with access to the Fine Tuning feature
...
## Deploy the fine-tuning bnode

Follow these steps to set up your training environment:

1. Click **Deploy the Fine Tuning Bnode**
...
After your bnode is deployed and active, you can connect using any of these methods:

1. Go to your Fine Tuning bnode dashboard
...
To use SSH, add your public SSH key in your account settings. The system automatically adds your key to the bnode's `authorized_keys` file.
