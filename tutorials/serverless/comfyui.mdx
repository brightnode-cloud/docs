...
If you need a model that's not listed here, or have your own LoRA, or need custom nodes, you can use this [customization guide](https://github.com/Brightnode-workers/worker-comfyui/blob/main/docs/customization.md) to create your own custom worker.
</Accordion>
...
You can create custom workflows by modifying node parameters or [opening the ComfyUI interface in a Node](/tutorials/nodes/comfyui) and exporting the workflow to JSON.
