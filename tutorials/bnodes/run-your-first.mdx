...
First, you'll deploy a Pod using the official Brightnode PyTorch template:
...
1. In the Brightnode console, find and expand your deployed Pod and click **Connect**.
...
1. Go back to the Brightnode console and click **Connect** on your Pod again.
...
<Tip>
JupyterLab is one of several [built-in utility services](/pods/utility-services) included with every Pod. You'll also find VS Code Server, system monitoring, file browser, and other tools pre-configured and ready to use.
</Tip>
