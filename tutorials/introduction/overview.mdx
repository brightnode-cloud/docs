...
<CardGroup cols={2}>
  ...
  <Card title="Run LLM inference on Nodes with JupyterLab" href="/tutorials/nodes/run-your-first" icon="text-size" iconType="solid">
    Launch JupyterLab on a GPU Node and run LLM inference using the Python `transformers` library.
  </Card>
</CardGroup>

## Deploy ComfyUI

Learn how to deploy ComfyUI on Serverless or Nodes and generate images with text-to-image models.
...
<CardGroup cols={2}>
  ...
  <Card title="Generate images with ComfyUI on Nodes" href="/tutorials/nodes/comfyui" icon="images" iconType="solid">
    Deploy ComfyUI on a GPU Node and generate images using the ComfyUI web interface.
  </Card>
</CardGroup>