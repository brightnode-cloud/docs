...
This walkthrough teaches you how to persist data outside of container. Brightnode has the same concept used for attaching a Network Volume to your Node.

Consult the documentation on [attaching a network volume to your Node](/storage/network-volumes).
