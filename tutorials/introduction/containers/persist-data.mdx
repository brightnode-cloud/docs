...
This walkthrough teaches you how to persist data outside of container. Brightnode has the same concept used for attaching a Network Volume to your Bnode.

Consult the documentation on [attaching a network volume to your Bnode](/storage/network-volumes).
...
Remember, this is a general tutorial on Docker. These concepts will help give you a better understanding of working with Brightnode.
