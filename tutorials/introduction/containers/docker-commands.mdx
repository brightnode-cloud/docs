...
Brightnode enables bring-your-own-container (BYOC) development. If you choose this workflow, you will be using Docker commands to build, run, and manage your containers.
...
For the purposes of using Docker with Brightnode, you should ensure your build command uses the `--platform=linux/amd64` flag to build for the correct architecture.
...
When working with a Docker and Brightnode, see how to [attach a network volume](/storage/network-volumes).
