...
This tutorial will guide you through setting up [Ollama](https://ollama.com), a powerful platform serving large language model, on a GPU Pod using Brightnode. Ollama makes it easy to run, create, and customize models.
...
1. Log in to your [Brightnode account](https://www.console.brightnode.cloud/pods) and choose **+ GPU Pod**.
...
Once the Pod is up and running, you'll have access to a terminal within the Brightnode interface.
...
This tutorial provides a foundational understanding of setting up and using Ollama on a GPU Pod with Brightnode.

* **Port Configuration and documentation**: For further details on exposing ports and the link structure, refer to the [Brightnode documentation](/pods/configuration/expose-ports).
