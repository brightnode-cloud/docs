...
1. Login to [Brightnode](https://www.console.brightnode.cloud/console/home) and deploy your Pod.
...
To use a local dataset, you'll need to transfer it to your Brightnode instance. You can do this using Brightnode CLI to securely transfer files from your local machine to the one hosted by Brightnode. All Pods automatically come with `brightnodectl` installed with a Pod-scoped API key. **To send a file**
