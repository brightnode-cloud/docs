...
Use GPU pools when defining requirements for repositories published to the [Brightnode Hub](/hub/publishing-guide#Brightnode-configuration), or when specifying GPU requirements for an endpoint with the [Brightnode GraphQL API](https://graphql-spec.brightnode.cloud/).
