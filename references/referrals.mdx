...
Earn Brightnode Credits when users you refer spend on Serverless or Nodes. The referral program rewards both you and the person you refer, creating a win-win situation for everyone involved.
...
- **3% commission** on all Node spend for the first 6 months.
...
The creator program rewards users who build popular [Node templates](/nodes/templates/overview) that others use on the platform. Every time someone runs a Node using your template, you earn a percentage of their spend.
...
For example, if 20 users run Nodes using your template at \$0.54/hour for a full week, you'll earn \$18.14 in credits. The more useful and popular your template, the more you can earn.
...
1. **Referral commissions are based on actual usage, not purchases.** If someone you refer buys \$1,000 in credits, you won't earn commission until they actually use those credits on Nodes or Serverless workloads.
