...
description: "Learn how to troubleshoot declined payment cards and prevent service interruptions on Brightnode."
---

Payment card declines can occur when adding funds to your Brightnode account. Credit card processors apply stringent fraud detection standards, particularly for international transactions. This document provides guidance to help you troubleshoot payment issues.
...
You can enable automatic balance refresh from the [Billing page](https://www.console.brightnode.cloud/user/billing):
...
If you're still having trouble after checking with your bank, contact [Brightnode support](https://www.brightnode.cloud/contact) for assistance.
