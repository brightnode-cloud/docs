...
If you see a "Token authentication is enabled" screen when trying to access your Bnode's JupyterLab server, follow the steps below to log in.
...
1. Go to the Bnode page in the Brightnode console and click the **Connect** button for the Bnode you want to access.
