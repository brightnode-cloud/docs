...
If you see a "Token authentication is enabled" screen when trying to access your Node's JupyterLab server, follow the steps below to log in.
...
1. Go to the Node page in the Brightnode console and click the **Connect** button for the Node you want to access.
