...
- [From a template](https://docs.brightnode.cloud/pods/templates/overview): Pre-configured environments for quick setup of common workflows.
...
- **Web proxy**: HTTP access to [exposed web services](/pods/configuration/expose-ports) via URLs in the format `https://[pod-id]-[port].proxy.brightnode.net`.
