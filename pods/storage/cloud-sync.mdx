...
Brightnode's Cloud Sync feature makes it easy to upload your Pod data to external cloud storage providers, or download data from cloud storage providers to your Pod. This guide walks you through setting up and using Cloud Sync with supported providers.
...
<Steps>
  ...
  <Step title="Generate access credentials">
   ...
   <Step title="Sync your data with Brightnode">
    In the Brightnode console, navigate to the [Pods page](https://brightnode.cloud/console/pods) and select the Pod containing your data. Click **Cloud Sync**, then select **AWS S3** from the available providers.
    ...
    Click **Copy to/from AWS S3** to initiate the transfer. The transfer progress will be displayed in the Brightnode interface. Large datasets may take time depending on your Pod's network connection.
  </Step>
</Steps>
...
<Note>
Cloud Sync is compatible with Google Cloud Storage, but **not Google Drive**. However, you can transfer files between your Pods and Drive [using the Brightnode CLI](/pods/storage/transfer-files#transfer-files-between-google-drive-and-Brightnode).
</Note>
...
<Steps>
  ...
  <Step title="Sync your data with Brightnode">
    In the Brightnode console, navigate to the [Pods page](https://brightnode.cloud/console/pods) and select the Pod containing your data. Click **Cloud Sync**, then select **Google Cloud Storage** from the available providers.
    ...
    Click **Copy to/from Google Cloud Storage** to initiate the transfer. The transfer progress will be displayed in the Brightnode interface. Large datasets may take time depending on your Pod's network connection.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Sync your data with Brightnode">
    In the Brightnode console, navigate to the [Pods page](https://brightnode.cloud/console/pods) and select the Pod containing your data. Click **Cloud Sync**, then select **Azure Blob Storage** from the available providers.
    ...
    Click **Copy to/from Azure Blob Storage** to initiate the transfer. The transfer progress will be displayed in the Brightnode interface. Large datasets may take time depending on your Pod's network connection.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Sync your data with Brightnode">
    In the Brightnode console, navigate to the [Pods page](https://brightnode.cloud/console/pods) and select the Pod containing your data. Click **Cloud Sync**, then select **Backblaze B2** from the available providers.
...
<Steps>
  ...
  <Step title="Sync your data with Brightnode">
    In the Brightnode console, navigate to the [Pods page](https://brightnode.cloud/console/pods) and select the Pod containing your data. Click **Cloud Sync**, then select **Dropbox** from the available providers.
