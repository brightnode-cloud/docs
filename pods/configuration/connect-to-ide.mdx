...
Before you can connect to a Pod, you'll need an SSH key that is paired with your Brightnode account. If you don't have one, follow these steps:
...
<Tabs>
  ...
  <Tab title="VSCode">
   1. From the [Pods](https://www.brightnode.cloud/console/pods) page, select the Pod you deployed.
...
5. Add the following to the SSH config file:
   ...
   Replace:
   - `POD_NAME` with a descriptive name for your Pod. This will be used to identify your Pod in the SSH config file, and does not need to match the name you gave your Pod in the Brightnode console.
