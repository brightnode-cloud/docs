...
Reference your secrets directly in the [environment variables section](/pods/templates/environment-variables) of your Pod template using the `BRIGHTNODE_SECRET_` prefix followed by your secret name:
...
This syntax tells Brightnode to substitute the encrypted secret value when the Pod starts, making it available as an environment variable inside your container.
