...
Before you can SSH into a worker, you'll need to generate an SSH key and add it to your Brightnode account.
...
If you're asked for a password when connecting to your worker via SSH, this means something is not set up correctly. Brightnode does not require a password for SSH connections, as authentication is handled entirely through your SSH key pair.
