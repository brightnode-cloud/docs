...
Brightnode's validator utility ensures robust execution of serverless workers by validating input data against a defined schema.

To use it, import the following to your Python file:

```py
from brightnode.serverless.utils.rp_validator import validate
```
