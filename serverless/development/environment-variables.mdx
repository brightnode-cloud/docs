...
1. **Accessing Environment Variables Setting**: In the template creation/editing interface of your node, navigate to the bottom section where you can set environment variables.
