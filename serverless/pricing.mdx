...
Brightnode Serverless offers flexible, pay-per-second pricing with no upfront costs. This guide explains how pricing works and how to optimize your costs.
...
For the latest pricing information, visit the [Brightnode pricing page](https://www.brightnode.cloud/pricing).

## How billing works

Serverless billing operates on a precise pay-as-you-go model with specific timing mechanisms.

Billing starts when the system signals a worker to wake up and ends when the worker is fully stopped. Brightnode Serverless is charged by the second, with partial seconds rounded up to the next full second. For example, if your request takes 2.3 seconds to complete, you'll be billed for 3 seconds.
...
If you think you've been billed incorrectly, please [contact support](https://www.brightnode.cloud/contact), and include this information in your request:
