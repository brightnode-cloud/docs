...
You can find endpoint metrics in the **Metrics** tab of the Serverless endpoint details page in the [Brightnode web interface](https://www.console.brightnode.cloud/serverless).
