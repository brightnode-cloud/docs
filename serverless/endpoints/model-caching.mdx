...
<Note>
Cached models are currently in beta. [Join our Discord](https://discord.gg/Brightnode) if you'd like to provide feedback.
</Note>
...
When you select a cached model for your endpoint, Brightnode automatically tries to start your workers on hosts that already contain the selected model.
...
<Steps>
  <Step title="Create a new endpoint">
    Navigate to the [Serverless section](https://www.console.brightnode.cloud/serverless) of the console and click **New Endpoint**.
  </Step>
