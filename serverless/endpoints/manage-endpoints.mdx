...
description: "Deploy and manage your endpoints using the Brightnode console or REST API."
---
...
<Tabs>
<Tab title="Web">
To create a new Serverless endpoint through the Brightnode web interface:

1. Navigate to the [Serverless section](https://www.console.brightnode.cloud/serverless) of the Brightnode console.
...
```bash
curl --request POST \
  --url https://rest.brightnode.cloud/v1/endpoints \
...
1. Navigate to the [Serverless section](https://www.console.brightnode.cloud/serverless) in the Brightnode console.
