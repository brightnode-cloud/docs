...
4. Testing your worker locally and on the Brightnode console.
...
If your workload requires additional capacity beyond 60 workers, [contact our support team](https://www.brightnode.cloud/contact).
