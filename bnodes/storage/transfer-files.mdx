...
|--------|----------|----------------|-----------------|
| **brightnodectl** | Quick, occasional transfers | Preinstalled on Bnodes | Small to medium files |
...
The simplest option for occasional transfers. Uses secure one-time codes and requires no setup since it's pre-installed on all Bnodes. Perfect for quick file exchanges.
...
From the source machine (your local computer or a Bnode), run:
