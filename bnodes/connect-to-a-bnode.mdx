...
This page covers the primary methods for connecting to your Pod. Every Pod also includes [built-in utility services](/pods/utility-services) like VS Code Server, system monitoring, file browser, and ML tools (TensorBoard, Gradio, etc.) that are accessible via your browser with no additional setup.
...
1.  Navigate to the [Pods page](https://console.brightnode.cloud/pods) in the Brightnode console.
...
JupyterLab is one of several [built-in utility services](/pods/utility-services) included with every Pod. Other services like VS Code Server, system monitoring, and ML tools are also available.

To connect to JupyterLab (if it's available on your Pod):

1.  Deploy your Pod, ensuring that the template is configured to run JupyterLab. Official Brightnode templates like "Brightnode Pytorch" are usually compatible.
2.  Once the Pod is running, navigate to the [Pods page](https://console.brightnode.cloud/pods) in the Brightnode console.
...
For more details about JupyterLab features and configuration, see [Built-in utility services](/pods/utility-services).
