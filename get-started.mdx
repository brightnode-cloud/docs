...
On the [Bnodes page](https://www.console.brightnode.cloud/bnodes), click the Bnode you just created to open the Bnode detail pane. The pane opens onto the **Connect** tab, where you'll find options for connecting to your Bnode so you can execute code on your GPU (after it's done initializing).
